...
epochs = 30                           #1 epoch: ca. 1hour10min
...
W_conv3 = weight_variable([f1, f1, f1_d,2*f1_d])
b_conv3 = bias_variable([2*f1_d])
W_conv4 = weight_variable([f1, f1,2*f1_d, 2*f1_d])
b_conv4 = bias_variable([2*f1_d])
W_conv5 = weight_variable([f1, f1,2*f1_d,4*f1_d])
b_conv5 = bias_variable([4*f1_d])
W_conv6 = weight_variable([f1, f1,4*f1_d, 4*f1_d])
b_conv6 = bias_variable([4*f1_d])
...
# dense Layer
h_flat = tf.reshape(h_conv6, [-1, re_coeff * 10 * f3_d])
h_fc1 = tf.nn.relu(tf.matmul(h_flat, W_fc1) + b_fc1)
# readout Layer
dense_out = tf.matmul(h_fc1, W_fc2) + b_fc2
