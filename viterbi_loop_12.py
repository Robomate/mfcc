...
def load_w_label(path, filename):
	...
	for line in reader:
		#print(line)
		matching = [s for s in line if "w_" in s]
		#print(matching)				
		get_w_label.append(matching[0][2:])
	#print(get_w_label)
	return get_w_label
...
hmm_file_list_sil, hmm_A_list_sil = hmm_sil(hmm_file_list,hmm_A_list,'sil')
...
recognized_hmm, prob_max = hmm_loop(hmm_file_list_sil,hmm_A_list_sil)
...
#~ print(w_label)
#ERI
w_label = load_w_label(path_w_label, w_label_name)
print('w_label')
print(w_label)
print('recognized_hmm')
print(recognized_hmm)
