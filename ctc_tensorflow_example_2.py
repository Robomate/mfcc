...
def run_ctc():
    ...
    def next_training_batch():
        ...
        random_index = '/home/root_alien/Desktop/philipp_eremy/00_VCTK-Corpus_Test/wav48/p225/p225_001.wav' # fix randomness
        print('random_index')
        print(random_index)
        training_element = audio.cache[random_index]
        target_text = training_element['target']
        print('training_element')
        print(training_element)
        print(training_element['audio'].shape)
        print('target_text')
        print(target_text)
    ...
    def next_testing_batch():
        ...
        from utils import convert_inputs_to_ctc_format
        random_index = random.choice(list(audio.cache.keys())[0:5])
        random_index = '/home/root_alien/Desktop/philipp_eremy/00_VCTK-Corpus_Test/wav48/p225/p225_136.wav' # fix randomness
        print('random_index')
        print(random_index)
        training_element = audio.cache[random_index]
        target_text = training_element['target']
