...
def create_ctc_label(minibatch_train_label):
	'''create sparse labels for ctc'''
	x=3
...
def training(epochs,train_samples):
	...
	for epoch in range(1,epochs+1):
		...
		for minibatch in range(int(train_samples)):
			...
			#define minibatch_ctc_label:
			create_ctc_label(minibatch_train_label)
			
			
			
			# start feeding data into the model: ctc
			#feedtrain_ctc = {x_input: minibatch_train_data,y_target2: minibatch_ctc_label, seq_len: batsize_train}
